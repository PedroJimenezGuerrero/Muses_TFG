...
public class InspiracionPolimniaStrategyTests {

    private InspiracionPolimniaStrategy strategy;
    ...
    @Test
    public void supportsSoloParaPolimnia() {
    ...
    @Test
    public void executeSolEnPosicion0ColocaTokensEnGrid2() {
        tablero.setSolPos(0);
    ...
    @Test
    public void executeSolEnPosicion2ColocaTokensEnGrid8() {
        tablero.setSolPos(2);
    ...
    @Test
    public void executeSolEnPosicion4ColocaTokensEnGrid6() {
        tablero.setSolPos(4);
    ...
    @Test
    public void executeSolEnPosicion6ColocaTokensEnGrid0() {
        tablero.setSolPos(6);
