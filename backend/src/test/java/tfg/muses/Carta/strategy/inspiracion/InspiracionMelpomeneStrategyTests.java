...
public class InspiracionMelpomeneStrategyTests {

    private InspiracionMelpomeneStrategy strategy;
    ...
    @Test
    public void supportsSoloParaMelpomene() {
    ...
    @Test
    public void executeSolEnPosicion1ColocaTokensEnGrid3() {
        tablero.setSolPos(1);
    ...
    @Test
    public void executeSolEnPosicion3ColocaTokensEnGrid1() {
        tablero.setSolPos(3);
    ...
    @Test
    public void executeSolEnPosicion5ColocaTokensEnGrid5() {
        tablero.setSolPos(5);
    ...
    @Test
    public void executeSolEnPosicion7ColocaTokensEnGrid7() {
        tablero.setSolPos(7);
