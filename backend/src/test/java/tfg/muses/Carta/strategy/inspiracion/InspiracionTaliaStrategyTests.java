...
public class InspiracionTaliaStrategyTests {

    private InspiracionTaliaStrategy strategy;
    ...
    @Test
    public void supportsSoloParaTalia() {
    ...
    @Test
    public void executeSolEnPosicion1ColocaTokensEnGrid0() {
        tablero.setSolPos(1);
    ...
    @Test
    public void executeSolEnPosicion3ColocaTokensEnGrid2() {
        tablero.setSolPos(3);
    ...
    @Test
    public void executeSolEnPosicion5ColocaTokensEnGrid8() {
        tablero.setSolPos(5);
    ...
    @Test
    public void executeSolEnPosicion7ColocaTokensEnGrid6() {
        tablero.setSolPos(7);
