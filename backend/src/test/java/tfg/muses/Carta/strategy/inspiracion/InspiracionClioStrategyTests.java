...
public class InspiracionClioStrategyTests {

    private InspiracionClioStrategy strategy;
    ...
    @Test
    public void supportsSoloParaClio() {
    ...
    @Test
    public void executeSolEnPosicion1ColocaTokensEnGrid5() {
        tablero.setSolPos(1);
    ...
    @Test
    public void executeSolEnPosicion3ColocaTokensEnGrid7() {
        tablero.setSolPos(3);
    ...
    @Test
    public void executeSolEnPosicion5ColocaTokensEnGrid3() {
        tablero.setSolPos(5);
    ...
    @Test
    public void executeSolEnPosicion7ColocaTokensEnGrid1() {
        tablero.setSolPos(7);
